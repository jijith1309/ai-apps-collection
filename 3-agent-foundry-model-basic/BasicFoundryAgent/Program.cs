...
var endpoint = config["AZURE_FOUNDRY_PROJECT_ENDPOINT"] ?? throw new InvalidOperationException("AZURE_FOUNDRY_PROJECT_ENDPOINT is not set.");
var deploymentName = config["AZURE_FOUNDRY_PROJECT_DEPLOYMENT_NAME"] ?? "gpt-4o-mini";
